                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-7 col-md-7 ">
                            <div class="bg-red restaurant-entry">
                                <div class="row">
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    ...
                    <div class="col-xs-12 col-sm-3 popular-locations color-gray">
                        ...
                        <ul>
                        <li><a href="#"><h5>Allahabad city area</a> </li>
                        <li><a href="#">Civil lines </a> </li>
                            <li><a href="#">Rajapur</a> </li>
                            <li><a href="#"> chowk </a> </li>
                            <li><a href="#"> <h5> Varanasi </a> </li>
                            <li><a href="#">BHU campus</a> </li>
                            <li><a href="#">Naipura kalan</a> </li>
                            <li><a href="#">Newada</a> </li>
                            <li><a href="#">Shivdaspur</a> </li>
                            <li><a href="#">Bhelpur</a> </li>
                            <li><a href="#">Assi ghat</a> </li>                 
                           </ul>
                    </div>
                </div>
                <!-- top footer ends -->
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-red">
                        <h5> Head office: Address:</h5>
                            <p>Civil lines prayagraj.</p>
                            <h5>Made by:</h5>
                            <p>----- GCET PROJECT----
                            <h5>Call us at: <a href="tel:+914450005500">+919695877637</a></h5></div>
                        <div class="col-xs-12 col-sm-5 additional-info color-red">
                            <h5>Who are we?</h5>
